              ...
              <article className="flex flex-col" key={list.id}>
                <div className="flex items-center w-full h-[2.5rem] bg-[#f4f4f4] pl-[0.5rem]">
                  <input
                    ...
                    onChange={() => handleCheckedIdUpdate(list.id)}
                  />
                  {editedById === list.id ? (
                    <input
                      ref={editInputRef}
                  ...
                  <div className="flex gap-[0.6rem] pr-[0.5rem]">
                    {editedById === list.id ? (
                      <>
                        <button
                          onClick={() => setEditedById("")}
                          className={cx(TODO_LIST_BUTTON_CLASS)}
                        >
                          Cancel
                        </button>
                        <button
                          onClick={() => handleTodoListUpdate()}
                          className={cx(TODO_LIST_BUTTON_CLASS)}
                        >
                          Update
                        </button>
